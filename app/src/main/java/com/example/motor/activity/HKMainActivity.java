...
import com.example.motor.jna.CameraManager;
import com.example.motor.jna.CrashUtil;
import com.example.motor.jna.NotNull;
 ...
 * @modificationHistory
 */
public class HKMainActivity extends Activity implements Callback, View.OnTouchListener {
    ...
    //"222.173.103.228", "10096", "admin", "sanli1234"

    public final String ADDRESS = "222.173.103.228";
    public final int PORT = 10096;
    public final String USER = "admin";
    public final String PSD = "sanli1234";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        crashUtil.init(this);
        setContentView(R.layout.activity_hk_main);
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.e(TAG, "Player setVideoWindow release!" + m_iPort);
        if (-1 == m_iPort) {
            return;
        }
    ...
    private AlertDialog getDialongView(View view) {
        final AlertDialog.Builder builder6 = new AlertDialog.Builder(HKMainActivity.this);
    ...
    private RealPlayCallBack getRealPlayerCbf() {
        RealPlayCallBack cbf = new RealPlayCallBack() {
            ...
            public void fRealDataCallBack(int iRealHandle, int iDataType,
                ...
                // player channel 1
                HKMainActivity.this.processRealData(iDataType, pDataBuffer,
