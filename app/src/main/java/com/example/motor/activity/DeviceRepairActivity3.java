...
/**
 *  这个DeviceRepairActivity3是给待办任务那里点击进入查看更多正常流程进入的
 *
 */
...
/**
 * 这个activity是从维修工单列表过来的处理界面
 *
 */
public class DeviceRepairActivity3 extends BaseActivity {
    ...
    private void initView() {
        ...
        faultId = getIntent().getStringExtra("ID");
    ...
    private void btnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.scan_scan:
                if(!DoubleClickUtils.isFastDoubleClick()){
                    startActivityForResult(new Intent(DeviceRepairActivity3.this,
            ...
            case R.id.search:
                if(!DoubleClickUtils.isFastDoubleClick()){
                    intent.setClass(DeviceRepairActivity3.this,
        ...
        if (tvDeviceNumber.getText().toString().trim().equals("")) {
            ...
            if(TextUtils.isEmpty(faultId)){
                ...
                try{
                    ...
                    // 如果班组为“”的话就将UserId赋值为reginId，如果具体人为“”的话就将
                    // 这个字段很有用啊，这是接收人的字段
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String arg0) {
                ...
                if (commonResponseBean.getCode() == 1) {
                    ...
                    Intent intent = new Intent(DeviceRepairActivity3.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
                    toast(commonResponseBean.getMessage() );
                } else {
            ...
            public void onSuccess(String arg0) {
                try{
                    ...
                    if (commonResponseBean.getCode() == 1) {
                        ...
                        intent.setClass(DeviceRepairActivity3.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        toast(commonResponseBean.getMessage());
    ...
    private void toast(String text){
        Toast.makeText(DeviceRepairActivity3.this, text, Toast.LENGTH_SHORT).show();
    }
