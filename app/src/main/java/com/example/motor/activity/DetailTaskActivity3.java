...
/**
 * 这个任务详情是主页直接点击进去的那个设备详情，与其他2个设备详情区别的地方其中一点在于，
 * 返回按钮和home返回的写法不同，这里面是TaskItemBean
 *
 */
public class DetailTaskActivity3 extends BaseActivity {
    ...
    private TextView sendTask, processTask, tvTitle, tvDescription, tvInformation, problemDescription,
            ...
            deviceType, deviceManufacturer, expertScheme, tvSendPerson, feedback;
    ...
    private void init() {
        ...
        // 语音动画对话框的设计与实现
        try{
            dialog = new Dialog(DetailTaskActivity3.this, R.style.dialog_style);
    ...
    private void initListener(){
        ...
        sendTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!DoubleClickUtils.isFastDoubleClick()){
                    ...
                    intent.setClass(mActivity, SendTaskActivity3.class);
                    intent.putExtra("currentChooseItems", (Serializable) list);
                    startActivityForResult(intent, 8);// 先加一个requestCode 8
                }
            }
        });
        // 处理任务
        processTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!DoubleClickUtils.isFastDoubleClick()){
                    intent.setClass(mActivity, DeviceRepairActivity2.class);
                    intent.putExtra("ID", faultId); // 故障id
                    intent.putExtra("EquipmentNo", equipmentNo);
                    intent.putExtra("taskitembean1", taskItemBean);
                    startActivityForResult(intent, 9);// 先加一个requestCode 9
                }
            }
        });
            ...
            public void onSuccess(String arg0) {
                try {
                    ...
                    if (object1.getString("Code").equals("0")) {
                        intent.setClass(DetailTaskActivity3.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
                        ...
                        Log.e("DetailTaskActivity3", videoString);
                        // 下载视频文件
            ...
            public void onSuccess(String arg0) {
                try {
                    ...
                    if (object1.getString("Code").equals("0")) {
                        ...
                        Log.e("DetailTaskActivity3", equipmentNo);
                    } else {
                        toast(object1.getString("Message"));
                    }
                } catch (Exception e) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        switch(requestCode){
            ...
            case 9:
                ...
                if(resultCode == mActivity.RESULT_OK){
                    processTask.setClickable(false);
                    processTask.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            toast("请不要重复处理");
    ...
    private void toast(String text){
        Toast.makeText(DetailTaskActivity3.this, text, Toast.LENGTH_SHORT).show();
    }
