...
public class PerfectInformationActivity2 extends BaseActivity {
    ...
    private void init() {
        ...
        if(ContextCompat.checkSelfPermission(PerfectInformationActivity2.this,
        ...
        if(!permissionList.isEmpty()){
            ...
            ActivityCompat.requestPermissions(PerfectInformationActivity2.this, permissions, 1);
        } else {
            requestLocation();
        }
        // 根据设备编号获取设备信息
            ...
            public void onSuccess(String arg0) {
                try {
                    ...
                    if (commonResponseBean.getCode() == 1) {
                        ...
                        Intent intent = new Intent(PerfectInformationActivity2.this, LoginActivity.class);
            ...
            public void onSuccess(String arg0) {
                try {
                    ...
                    if (commonResponseBean.getCode() == 1) {
                        ...
                        pumpPower.setText(jsonObject.getString("power"));
                        systemFlow.setText(jsonObject.getString("SystemFlow"));
                        systemLift.setText(jsonObject.getString("SystemLift"));
                        importDn.setText(jsonObject.getString("ImportDN"));
                        exportDn.setText(jsonObject.getString("ExportDN"));
                        manufactureDate.setText(jsonObject.getString("ManufactureDate")
                                .replace("T", " "));
                        customerName.setText(jsonObject.getString("CustomerName"));
                        creater.setText(jsonObject.getString("Creater"));
                        customerPhone.setText(jsonObject.getString("CustomerPhone"));
    ...
    private void toast(String text){
        Toast.makeText(PerfectInformationActivity2.this, text, Toast.LENGTH_SHORT).show();
    }
}
