...
public class Tab {
    ...
    public Tab(Context context, String text, int textSize, int textColor, int selectedTextColor,
               ...
               int selectedIconImage, int index, boolean hasMsg) {
    ...
    private void initView() {
        ...
        LinearLayout.LayoutParams rootViewLp = new LinearLayout.LayoutParams(
        ...
        RelativeLayout.LayoutParams iconParam = new RelativeLayout.
                LayoutParams(iconWidth == 0 ? ViewGroup.LayoutParams.WRAP_CONTENT : iconWidth,
        ...
        RelativeLayout.LayoutParams txParam=new RelativeLayout.LayoutParams(
