...
import com.example.motor.adapter.BaseAdapter;
import com.example.motor.adapter.TabViewPagerAdapter;
import com.example.motor.listener.OnTabSelectedListener;
import com.example.motor.util.DisplayUtil;
...
public class TabContainerView extends RelativeLayout {
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)    //  lollipop  棒棒糖
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.TabContainerViewStyle);
        ...
        textSize = typedArray.getDimensionPixelSize(R.styleable.TabContainerViewStyle_tabTextSize,
                DisplayUtil.dip2px(context, 14));
        drawablePadding = typedArray.getDimensionPixelSize(R.styleable.TabContainerViewStyle_drawablePadding,
        ...
        divideLineHeight = typedArray.getDimensionPixelSize(R.styleable.TabContainerViewStyle_divideLineHeight,
    ...
    private void initViewPager(Context context) {
        ...
        LayoutParams contentVpLp = new LayoutParams(
    ...
    public void setAdapter(BaseAdapter baseAdapter, int index) {
        ...
        tabHost.addTabs(baseAdapter, textSize, textColor, selectedTextColor,
                drawablePadding, iconWidth, iconHeight);

        contentViewPager.setAdapter(new TabViewPagerAdapter(baseAdapter.getFragmentManager(),
                baseAdapter.getFragmentArray()));
