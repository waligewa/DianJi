...
public class GlobalSettingActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> aaChn = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_dropdown_item, alChn);
        ...
        m_btGlobalSet.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
        		...
        		boolean bPbStream = INetSDK.SetDeviceMode(TestNetSDKActivity.m_loginHandle,
                        EM_USEDEV_MODE.SDK_RECORD_STREAM_TYPE, m_nGlobalPbStream);
        		if (!bPbStream) {
