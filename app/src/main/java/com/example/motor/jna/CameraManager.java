...
//        m_oPreviewBtn.setText("Stop");
    ...
    public void startMove(int orientation, int m_iLogID) {
        ...
        switch (orientation) {
            case 9:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.UP_RIGHT, 0, 4);
                break;
            case 8:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.TILT_UP, 0, 4);
                break;
            case 7:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.UP_LEFT, 0, 4);
                break;
            case 6:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.PAN_RIGHT, 0, 4);
                break;
            case 5:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.PAN_AUTO, 0, 4);
                break;
            case 4:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.PAN_LEFT, 0, 4);
                break;
            case 3:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.DOWN_RIGHT, 0, 4);
                break;
            case 2:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.TILT_DOWN, 0, 4);
                break;
            case 1:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.DOWN_LEFT, 0, 4);
                break;
            default:
                break;
        }
    ...
    /**
     * 停止移动 NET_DVR_PTZControlWithSpeed参数：(播放标记, 通道， 指令码, 开始标记0或停止标记1)
     *
    ...
    public void stopMove(int orientation, int m_iLogID) {
        ...
        switch (orientation) {
            case 9:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.UP_RIGHT, 1, 0);
                break;
            case 8:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.TILT_UP, 1, 0);
                break;
            case 7:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.UP_LEFT, 1, 0);
                break;
            case 6:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.PAN_RIGHT, 1, 0);
                break;
            case 5:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.PAN_AUTO, 1, 0);
                break;
            case 4:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.PAN_LEFT, 1, 0);
                break;
            case 3:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.DOWN_RIGHT, 1, 0);
                break;
            case 2:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.TILT_DOWN, 1, 0);
                break;
            case 1:
                HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.DOWN_LEFT, 1, 0);
                break;
            default:
                break;
        }
    ...
    /**
     * 开始缩放 NET_DVR_PTZControlWithSpeed参数：(播放标记, 通道， 指令码, 开始标记0或停止标记1)
     *
     * @param x -1缩小 1放大
     */
...
//        }
        if (x < 0) {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.ZOOM_OUT, 0, 4);
        } else {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.ZOOM_IN, 0, 4);
        }
    }

    /**
     * 停止缩放 NET_DVR_PTZControlWithSpeed参数：(播放标记, 通道， 指令码, 开始标记0或停止标记1)
     *
     * @param x -1缩小 1放大
     */
    public void stopZoom(int x, int m_iLogID) {
        ...
        if (x < 0) {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.ZOOM_OUT, 1, 0);
        } else {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.ZOOM_IN, 1, 0);

        }
    }

    /**
     * 开始变焦 NET_DVR_PTZControlWithSpeed参数：(播放标记, 通道， 指令码, 开始标记0或停止标记1)
     *
     * @param x -1近端 1远端
     */
    public void startFocus(int x) {
        ...
        if (x < 0) {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.FOCUS_NEAR, 0, 4);
        } else {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.FOCUS_FAR, 0, 4);
        }
    }

    /**
     * 停止变焦 NET_DVR_PTZControlWithSpeed参数：(播放标记, 通道， 指令码, 开始标记0或停止标记1)
     *
     * @param x -1近端 1远端
     */
    public void stopFocus(int x) {
        ...
        if (x < 0) {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.FOCUS_NEAR, 1, 0);

        } else {
            HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(m_iLogID, PTZCommand.FOCUS_FAR, 1, 0);
        }
