...
public class TaskItemBean2 extends LitePalSupport implements Serializable {
    ...
    public TaskItemBean2 setMultipleChoiceSelected(boolean multipleChoiceSelected) {
    ...
    public TaskItemBean2 setShowPanel(boolean showPanel) {
