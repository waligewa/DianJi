package com.example.motor.baidu;
...
import com.example.motor.activity.DeviceStateActivity;
...
public class BNDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(DeviceStateActivity.ROUTE_PLAN_NODE);
            }
        }
        // 显示自定义图标
        if (hd != null) {
    ...
    private OnNavigationListener mOnNavigationListener = new OnNavigationListener() {
        ...
        public void notifyOtherAction(int actionType, int arg1, int arg2, Object obj) {
            ...
            Log.e(TAG, "actionType:" + actionType + "arg1:" + arg1 + "arg2:"
